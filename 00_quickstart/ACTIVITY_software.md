...
Install Python and/or R programming languages, along with an Integrated Development Environment (IDE) for writing and running code.
...
- [ ] After installation, update the `PATH` and `R_LIBS_USER` for R in this repository's [`.bashrc` file](.bashrc)
- [ ] Open **Git Bash** and run `source .bashrc` to load the settings for your session

### 🧱 Stage 4: Verify Your Installations

- [ ] Open **Git Bash**
- [ ] Test Python by running: `python --version` or `python3 --version`
- [ ] Test R by running: `R --version`
