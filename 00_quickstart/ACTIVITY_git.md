...
Install Git and Git Bash on your computer. Git Bash provides a Unix-like command-line interface on Windows, which you'll use throughout this course for running scripts and commands.
...
- [ ] Test Git by running: `git --version`
- [ ] Test curl by running: `curl --version`
